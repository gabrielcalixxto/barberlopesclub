    ...
    <footer className="bg-gradient-to-r from-gray-900 to-black text-white">
      <div className="max-w-6xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          {/* Logo e Descrição */}
          <div className="md:col-span-2 pl-2 md:pl-4">
            <p className="text-gray-300 text-lg mb-6 max-w-md font-bold">
          ...
          <div>
            ...
            <div className="space-y-3 text-gray-300">
              <div className="flex items-start gap-3">
                ...
                <p>Av. Vinte e Oito de Março, N° 560 - Parque Avenida Pelinca, Campos dos Goytacazes - RJ, 28020-740<br />Ao Lado do Shopping</p>
              </div>
